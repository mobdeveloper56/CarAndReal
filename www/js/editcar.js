...
$(document).ready(
    function () {
        $("#car_model").attr("placeholder", carmodel);
...
function carDetailData(data) {
    for (var i = 0; i < data.carlist.length; i++) {
        ...
        document.getElementById("car_model").value = car_model_name;
...
{
    $("#car_model").attr("placeholder", car_model);
}
